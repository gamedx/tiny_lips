...
flags.DEFINE_float('regularization_scale', 7.2, 'regularization coefficient for reconstruction loss, default to 0.0005*120*120=7.2')
...
flags.DEFINE_integer('num_threads', 16, 'number of threads of enqueueing examples')
