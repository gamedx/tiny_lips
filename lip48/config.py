...
flags.DEFINE_float('regularization_scale', 1.152, 'regularization coefficient for reconstruction loss, default to 1.152')
...
flags.DEFINE_integer('batch_size_per_gpu', 1, 'batch size on 1 gpu')
