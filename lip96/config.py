...
flags.DEFINE_integer('epoch', 18, 'epoch')
flags.DEFINE_integer('iter_routing', 128, 'number of iterations in routing algorithm')
flags.DEFINE_boolean('mask_with_y', False, 'use the true label to mask out target capsule or not') 
flags.DEFINE_float('stddev', 0.01, 'stddev for W initializer')
flags.DEFINE_float('regularization_scale', 4.608, 'regularization coefficient for reconstruction loss, default to 4.608')
...
flags.DEFINE_integer('batch_size_per_gpu', 2, 'batch size on 1 gpu')
